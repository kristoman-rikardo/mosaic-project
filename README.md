...
## 4. AI Declaration
**Now, the big question**, the __AI__ question. It is now me, the human Kristoffer, writing this. After a fun and intensive period of working on this project, I can with sincerity say that this is one of the projects I have done where I have __*really*__ tried to think more myself, without AI. This made it a more difficult, funner experience filled with revelations. I worked through the complete logic of the project, in addidtion to the architecture museslf, without ever consulting AI (except for some questions on the idea when I got it back in October). It was fun writing the logic, but parts of the frontend, except for all parts ochestrating it all, are written with the help of Gemini Pro. Thanks. Also, the text answering the questions with the flawless english is written by Sonnet. I truly believe AI is here to stay, and that we optimistically that we are all slightly doomed (for the better?). But I somewhat doubt that all of software is dead. Thouh software development by humans mass producing probably is, enterprise software, architecture and innovation will until further notice be driven by humans, maybe in collaboration with humans. 
